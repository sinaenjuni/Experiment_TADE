...
class ResNet_s(nn.Module):
    ...
    def __init__(self, block, num_blocks,
                 num_experts, num_classes=10,
                 reduce_dimension=False, layer2_output_dim=None,
                 layer3_output_dim=None, use_norm=False,
                 returns_feat=True, use_experts=None, s=30):
...
def resnet32(num_classes=10, use_norm=False):
    return ResNet_s(BasicBlock, [5, 5, 5], num_experts=3, num_classes=num_classes, use_norm=use_norm)
...
if __name__ == "__main__":
    ...
    print(rest32)
    out = rest32(torch.rand((32,3,32,32)))